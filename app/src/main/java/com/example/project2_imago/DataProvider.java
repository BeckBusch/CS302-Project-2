...
public class DataProvider {
    ...
    public DataProvider() {
        ...
        MonitorData.add(new DesignMonitor("LG Technik", true, 0, 1170, "LG", 27, "16:9", "3840x2160", "IPS"));
        ...
        MonitorData.add(new BusinessMonitor("Dell Super Optic", true, 0, 645, "Dell", 24, "16:9", 120, true));
        MonitorData.add(new BusinessMonitor("LG Ultrafine 27", true, 0, 663, "LG", 27, "16:9", 100, true));
